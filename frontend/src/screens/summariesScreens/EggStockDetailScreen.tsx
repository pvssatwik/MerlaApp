...
const EggStockDetailScreen = ({ navigation }: any) => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const result = await authGet("/api/transactions/egg-stock-summary");
      setData(result.data);
    } catch (err: any) {
              ...
              <View style={styles.cardRow}>
                <View style={styles.cardStat}>
                  ...
                  <Text style={styles.statValue}>
                    {row.OPENING_BAL?.toLocaleString()}
                  </Text>
                </View>
                <View style={styles.cardStat}>
              ...
              <View style={[styles.cardRow, { marginTop: 10 }]}>
                ...
                <View style={styles.cardStat}>
                  ...
                  <Text
                    style={[
                      styles.statValue,
                      row.CLOSING_BALANCE < 0 && styles.negative,
                    ]}
                  >
                ...
                <View style={styles.cardStat}>
                  ...
                  <Text style={styles.statValue}>
                    {row.MEDIUM_EGGS?.toLocaleString()}
                  </Text>
                </View>
              </View>
            </View>
